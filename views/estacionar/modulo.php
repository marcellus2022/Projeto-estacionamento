                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a title="Estacionar" href="<?php echo base_url('estacionar'); ?>">Estacionar</a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (isset($estacionado)): ?>
                            ...
                            <p class="text-muted small mb-4"><i class="ik ik-edit-1 ik-2x">&nbsp;&nbsp;</i>Última atualização:&nbsp;&nbsp;</i><?php echo formata_data_banco_com_hora($estacionado->estacionar_data_alteracao); ?></p>
