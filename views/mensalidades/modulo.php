                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a title="Mensalidades" href="<?php echo base_url('mensalidades'); ?>">Mensalidades</a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (isset($mensalidade)): ?>
                            ...
                            <p class="text-muted small mb-4"><i class="ik ik-edit-1 ik-2x">&nbsp;&nbsp;</i>Última atualização:&nbsp;&nbsp;</i><?php echo formata_data_banco_com_hora($mensalidade->mensalidade_data_alteracao); ?></p>
                        ...
                        <form class="forms-sample" name="form_modulo" method="post">
                                    ...
                                    <select class="form-control mensalistas select2" name="mensalidade_mensalista_id" <?php echo (isset($mensalidade) ? 'disabled' : ''); ?>>
                                        ...
                                        <?php foreach ($mensalistas as $mensalista): ?>
                                            ...
                                            <?php if (isset($mensalidade)): ?>
                                                ...
                                                <option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalista_dia_vencimento ?>" <?php echo ($mensalista->mensalista_id == $mensalidade->mensalidade_mensalista_id ? 'selected' : '') ?>><?php echo $mensalista->mensalista_nome . '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;CPF ou CNPJ&nbsp&nbsp;' . $mensalista->mensalista_cpf_cnpj; ?></option>                                                

                                            <?php else: ?>

                                                <option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalista_dia_vencimento ?>"><?php echo $mensalista->mensalista_nome . '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;CPF ou CNPJ&nbsp&nbsp;' . $mensalista->mensalista_cpf_cnpj; ?></option>
                            ...
                            <?php else: ?>
                                <a title="Cadastrar mensalidade" href="javascript:void(0)" class="btn btn btn-primary mr-2" data-toggle="modal" data-target="#mensalidade"><?php echo $valor_btn ?></i></a>                            
                            <?php endif; ?>
